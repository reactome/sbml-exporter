...

{
        ...
        private String model_out = String.format("<?xml version='1.0' encoding='utf-8' standalone='no'?>%n" +
                ...
                "  <model name=\"Entry of Influenza Virion into Host Cell via Endocytosis\" id=\"pathway_168275\" metaid=\"metaid_1\">%n" +
                "    <listOfCompartments>%n" +
                "      <compartment name=\"plasma membrane\" constant=\"true\" id=\"compartment_876\" metaid=\"metaid_4\" />\n" +
                "      <compartment name=\"endocytic vesicle membrane\" constant=\"true\" id=\"compartment_24337\" metaid=\"metaid_6\" />\n" +
                "      <compartment name=\"endosome lumen\" constant=\"true\" id=\"compartment_171907\" metaid=\"metaid_8\" />\n" +
                "    </listOfCompartments>%n" +
                "    <listOfSpecies>%n" +
                "      <species boundaryCondition=\"false\" constant=\"false\" metaid=\"metaid_3\" hasOnlySubstanceUnits=\"false\" compartment=\"compartment_876\"\n" +
                "      name=\"Sialic Acid Bound Influenza A Viral Particle [plasma membrane]\" id=\"species_188954\" />\n" +
                "      <species boundaryCondition=\"false\" constant=\"false\" metaid=\"metaid_5\" hasOnlySubstanceUnits=\"false\" compartment=\"compartment_24337\"" +
                " name=\"SA [endocytic vesicle membrane]\" id=\"species_189161\" />\n" +
                "      <species boundaryCondition=\"false\" constant=\"false\" metaid=\"metaid_7\" hasOnlySubstanceUnits=\"false\" compartment=\"compartment_171907\"" +
                " name=\"Influenza A Viral Particle [endosome lumen]\"\n" +
                "      id=\"species_189171\" />\n" +
                "    </listOfSpecies>%n" +
                "    <listOfReactions>%n" +
                "      <reaction name=\"Clathrin-Mediated Pit Formation And Endocytosis Of The Influenza Virion\" fast=\"false\" id=\"reaction_168285\" metaid=\"metaid_2\" reversible=\"false\">\n" +
                "        <listOfReactants>%n" +
                "          <speciesReference constant=\"true\" id=\"speciesreference_168285_input_188954\" species=\"species_188954\" />\n" +
                "        </listOfReactants>%n" +
                "        <listOfProducts>%n" +
                "          <speciesReference constant=\"true\" id=\"speciesreference_168285_output_189161\" species=\"species_189161\" />\n" +
                "          <speciesReference constant=\"true\" id=\"speciesreference_168285_output_189171\" species=\"species_189171\" />\n" +
                "        </listOfProducts>%n" +
                "      </reaction>%n" +
                "    </listOfReactions>%n" +
                "  </model>%n" +
...
//            assertEquals(model_out, testWrite.toString());
//            assertTrue(model_out.equals(ss));
